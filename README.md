...
**[Fuzzing the Poly/ML Compiler](https://github.com/aravinth-kanesh/polyml-fuzz)**
`C` `LLVM` `AFL++`
...
**[Crux](https://github.com/aravinth-kanesh/crux)**
`C++` `CMake`
...
**[Real-Time Market Data Simulator](https://github.com/aravinth-kanesh/market-data-simulator)**
`Python` `asyncio`
Streaming market data engine. 1.4M+ ticks/sec, sub-200µs p99 latency, zero message loss.

**[Auteur](https://github.com/aravinth-kanesh/auteur)**
