...
- Found 4 reliability findings in upstream Poly/ML: ARM64-specific UBSan overflow in arm64.cpp:246, lexer OOM on pathological float literals, and 3 SIGSEGV crashes from a type safety defect in overloading resolution
