...
**Languages:**  
Python · Java · C++ · JavaScript · TypeScript · Scala · SQL  

**Frameworks & Tools:**  
React · Vite · Spring Boot · Django · Flask · FastAPI · Docker · Redis · Git  

**Web & UI:**  
HTML · CSS · JavaFX  

**Practices:**  
Agile · Test-Driven Development · CI/CD · Microservices  
...
- Created an **offline data pre-processing pipeline** to clean, enrich and **vectorise** CV/job data using an **LLM**
